...
> Ojala el Alzheimer no toque la puerta

_Cuando se espera que la memoria humana se comporte como almacenamiento estructurado_

## Nota de campo sintética

Esta nota nacio como un error interpretativo durante la traducción de [El cerebro humano no es una base de datos](../organization-factors/the-human-brain-is-not-a-database.md).
