...
flowchart LR
    ...
    B6["Rutas alternativas<br/><small>¿Existen otros recorridos válidos?</small>"]
    B7["Artifacts clave<br/><small>¿Qué artifacts no deberían saltarse?</small>"]
    B8["Señales de orientación<br/><small>¿Cómo saber dónde estamos dentro del recorrido?</small>"]
    B9["Desvíos útiles<br/><small>¿Qué caminos secundarios pueden explorarse?</small>"]
    B10["Riesgos de navegación<br/><small>¿Qué puede malinterpretarse si se recorre mal?</small>"]
