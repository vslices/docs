...
Esos elementos son expresiones de algo más profundo. Un negocio opera a través del conocimiento:
...
El software se vuelve valioso cuando preserva y ejecuta parte de ese conocimiento. 

Pero se vuelve frágil cuando ese conocimiento se pierde.

## El problema

Muchos sistemas no fallan solo porque el código sea malo. Fallan porque el conocimiento detras del código desaparece.

El sistema puede seguir compilando. Las pruebas pueden seguir pasando. Los servicios pueden seguir ejecutándose.
...
En ese punto,Entonces el sistema se vuelve más difícil de evolucionar con seguridad.
...
Un fallo común es documentar todo por adelantado como si el dominio no fuera a cambiar. Esto crea conocimiento congelado.

La documentación puede ser detallada, pero lentamente deja de representar la realidad:
...
Pero la documentación permanece como una imagen de un sistema anterior.

En este caso, la documentación no preserva continuidad. Preserva una captura.

## Conocimiento encapsulado

El fallo opuesto es no documentar nada y confiar en que el código será suficiente. Esto crea conocimiento encapsulado: conocimiento que todavía existe, pero está encerrado dentro de:
...
El código puede ejecutar una decisión, mostrar lo que ocurre y sugerir cómo funciona algo. Pero el código rara vez explica lo suficiente por sí solo:
...
Cuando aparecen las consecuencias del conocimiento olvidado, la diferencia se vuelve visible:

* instruir software no es lo mismo que enseñar a las personas
* programar no es lo mismo que explicar
...
Esto es útil. Pero escribir con menos esfuerzo no crea automáticamente mejor continuidad del conocimiento.

La IA puede ayudar con escritura, organización y resumen. Pero no elimina la responsabilidad de ingeniería de decidir:
...
Modernización y reinvención no son lo mismo.

La modernización ocurre cuando un sistema evoluciona preservando el conocimiento que le da significado.

La reinvención ocurre cuando el conocimiento se perdió y el equipo debe redescubrir lo que la organización ya sabía.

Muchas reescrituras no ocurren solo por código malo, frameworks viejos o infraestructura obsoleta. También ocurren porque el sistema ya no puede entenderse.

El conocimiento de negocio todavía existe en algún lugar, pero está fragmentado entre:
...
Cuando esto ocurre, reconstruir el sistema se convierte en un proyecto de recuperación de conocimiento disfrazado de modernización técnica.
...
El objetivo no es la documentación perfecta. Es significado recuperable.
...
Cuando ese conocimiento deja de fluir, el sistema comienza a degradarse.

Cuando ese conocimiento permanece visible, conectado y evolutivo, el sistema puede cambiar sin perderse a sí mismo.
