...
!!! risk "Riesgo a evitar"
    ...
    Cuando el dominio es poco claro, fragmentado, manual, condicionado por legado u organizacionalmente complejo, partir directamente desde la implementación puede crear complejidad accidental.
...
VSlices Design proporciona:

* **modalidades de diseño** para decidir si conviene empezar desde contexto, problema o slice
* **herramientas de razonamiento** para conectar dominio, decisiones y estructura de software
* **heurísticas de modelado** para observar límites, responsabilidades, comportamientos e incertidumbre
* **criterios de cambio de modalidad** para ajustar el enfoque cuando cambia la incertidumbre dominante
* **lenguaje compartido de diseño** para discutir decisiones antes de convertirlas en arquitectura o implementación
