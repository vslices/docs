...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| El equipo no entiende cómo ocurre actualmente el trabajo.                                     | [***Context-First***](../../design/modalities/context-first/index.md) | La siguiente decisión necesita un entendimiento más amplio del dominio y del proceso. |
...
| Un experimento pequeño puede revelar de forma segura cómo reaccionan las personas al soporte. | [***Slice-First***](../../design/modalities/slice-first/index.md)     | El equipo puede aprender mediante un prototipo o vertical slice acotada.              |
...
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Las personas usan términos de forma inconsistente.             | Vocabulario de dominio (*Domain Vocabulary*) — [Taxonomía](../../docs-standard/taxonomy/domain-vocabulary.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/domain-vocabulary.md)       |
| El escenario circundante necesita entenderse.                  | Documento de contexto (*Context Document*) — [Taxonomía](../../docs-standard/taxonomy/context-document.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/context-document.md)           |
| El trabajo depende de pasos, *handoffs* o responsabilidades.   | Documento de proceso (*Process Document*) — [Taxonomía](../../docs-standard/taxonomy/process-document.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/process-document.md)            |
| Un comportamiento debería ser apoyado por *software*.          | Documento de caso de uso (*Use Case Document*) — [Taxonomía](../../docs-standard/taxonomy/use-case-document.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/use-case-document.md)     |
| Está emergiendo una capacidad estable de negocio.              | Documento de capacidad (*Capability Document*) — [Taxonomía](../../docs-standard/taxonomy/capability-document.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/capability-document.md) |
| Debe elegirse una dirección bajo *tradeoffs*.                  | Registro de decisión (*Decision Record*) — [Taxonomía](../../docs-standard/taxonomy/decision-record.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/decision-record.md)               |
| Evidencia temprana cambia lo que el equipo cree.               | Nota de validación (*Validation Note*) — [Taxonomía](../../docs-standard/taxonomy/validation-note.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/validation-note.md)                 |
| Las observaciones todavía son inciertas, locales o temporales. | Nota de soporte (*Support Note*) — [Taxonomía](../../docs-standard/taxonomy/support-note.md) · [Template](https://github.com/vslices/docs-standard/blob/main/templates/support-note.md)                             |
