...
!!! principle "Principio de selección"

    Elige la modalidad según la incertidumbre que más importa ahora.
    

La pregunta no es: _¿Qué modalidad preferimos?_, sino: _¿Qué tipo de incertidumbre haría insegura la siguiente decisión?_
...
| Señal actual | Modalidad | Por qué |
| --- | --- | --- |
