...
El objetivo de esta sección es ayudarte a entender qué es VSlices, por qué existe, cómo se relacionan sus productos y qué partes todavía están siendo validadas intencionalmente.
...
4. [Rutas de adopción postergadas](adoption-paths.md)

Este orden presenta VSlices desde la idea general antes de avanzar hacia documentación específica de cada producto.
...
| Entender cómo VSlices se valida mediante trabajo real | [Alive Lab](../alive-lab/index.md) |
| Revisar decisiones metodológicas y de producto | [Decisiones](../decisions/index.md) |

## Estado actual

VSlices todavía está siendo definido y validado.

Algunas páginas están disponibles intencionalmente como trabajo en progreso. Otras áreas, como las rutas de adopción, están postergadas hasta que exista suficiente validación desde trabajo real.

Esta documentación debe leerse como una base actual para aprender qué problemas intenta resolver VSlices mediante diseño, documentación, validación e implementación.
