...
flowchart LR
    ...
    P1 --> C1[["<b>Capability</b><br/>[Capacidad expuesta]<br/><small><a href='link'>Behavior Document</a><br/><a href='link'>Structure Document</a></small>"]]
    P1 --> C2{{"<b>Capability</b><br/>[Capacidad que requiere definición]<br/><small>Scope Document<br/>Behavior Document</small>"}}
    ...
    P3 --> CU1[["<b>Consumption Model</b><br/>[Forma de consumo documentada]<br/><small><a href='link'>Structure Document</a><br/><a href='link'>Behavior Document</a></small>"]]
    P3 --> CU2{{"<b>Consumption Model</b><br/>[Forma de consumo que requiere documentación]<br/><small>Structure Document<br/>Behavior Document</small>"}}
    ...
    P4 --> E1{{"<b>Expected Error</b><br/>[Error, límite o fallo esperado]<br/><small>Behavior Document<br/>Support Note kind: testing-spec</small>"}}
    ...
    P5 -.-> SP1>"<b>Software Project</b><br/>[Proyecto relacionado]"]

    P6 -.-> DEC1[["<b>Decision</b><br/>[Decisión documentada]<br/><small><a href='link'>Decision Record</a></small>"]]
    P6 -.-> DEC2{{"<b>Service Decision</b><br/>[Decisión pendiente]<br/><small>Decision Record</small>"}}
```
