...
The goal of this section is to help you understand what VSlices is, why it exists, how its products relate to each other, and which parts are still intentionally being validated.
...
| Understand how VSlices is validated through real work | [Alive Lab](../alive-lab/index.md) |
| Review methodological and product decisions | [Decisions](../decisions/index.md) |

## Current state

VSlices is still being defined and validated.

Some pages are intentionally available as work in progress. Other areas, such as adoption paths, are postponed until there is enough validation from real work.

This documentation should be read as a current foundation for learning what problems VSlices tries to solve through design, documentation, validation, and implementation.
