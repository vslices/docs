...
The Collaboration Model explains how people or teams can work with VSlices Method without losing continuity.
...
- A small team may hold all responsibilities together.
- A larger organization may distribute them across different people or teams.

The important rule is not who holds each responsibility, but whether continuity is preserved:

!!! principle "Collaboration principle"
...
They do not need to be separated. They only need to be visible enough to preserve continuity.
...
* **Continuity responsibility**: brings new learning back into the shared context.
...
Each stage should leave enough knowledge for the next one to move forward without guessing:

* Understanding should avoid disconnected notes.
* Contextualizing should avoid documents that nobody uses.
* Planning should avoid decisions without context.
* Building should avoid behavior implemented without intent.
* Validation should avoid isolated feedback that never changes future work.
...
The purpose of a handoff is not to transfer documents. It is to transfer enough understanding for work to continue without losing meaning.

## Small teams

In a small team, collaboration may happen through direct conversation. Documentation can remain light.

The main risk is that knowledge stays implicit because everyone believes the context is already shared. Small teams should preserve knowledge when:
...
The smaller the team, the more tempting it is to rely only on memory. VSlices Method should help preserve the few important pieces of knowledge that future work should not have to rediscover.

## Larger organizations

In a larger organization, responsibilities may be distributed across different groups. For example:

* one group may discover domain signals
