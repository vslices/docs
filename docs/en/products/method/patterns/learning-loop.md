...
That evidence may confirm the current direction, refine the context, challenge a decision or reveal a new line of work.
...
* **Confirmed** means the evidence supports the current understanding or decision.
* **Refined** means the direction was useful, but some details need adjustment.
* **Challenged** means the evidence contradicts an assumption, decision or model.
* **Split** means the feedback reveals a separate work line or concern.
* **Superseded** means previous knowledge no longer represents the current reality.
...
* an expected error that was missing
...
* record a Validation Note
* review a Decision Record
* refine the current Use Case or Capability
* return to Contextualizing
* return to Planning
* switch design modality
* open a new Work Line
* stop the iteration because enough value was delivered
